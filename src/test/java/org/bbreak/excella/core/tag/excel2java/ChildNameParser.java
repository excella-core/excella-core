 ...
 *
 * $Id: ChildNameParser.java 128 2009-07-02 06:32:17Z yuta-takahashi $
 * $Revision: 128 $
 *
 ...
 * @since 1.0
 */
public class ChildNameParser extends ObjectsPropertyParser {
     ...
     * @param tag タグ
     */
    public ChildNameParser( String tag) {
        super( tag);
    }
    ...
    public void parse( Object object, Object cellValue, String tag, Map<String, String> params) throws ParseException {
        ...
        if ( object instanceof TargetEntity) {
            ...
            childEntity.setChildName( ( String) cellValue);
